...
import { X, ShoppingBag, Trash2, ShieldCheck, CreditCard, CheckSquare, Square, Lock } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-[120] overflow-hidden">
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-10">
        <div className="w-screen max-w-md bg-[#111112] border-l border-white/10 text-white flex flex-col shadow-2xl">
          ...
          {/* Relative Container with Blur Rule for Cart Body */}
          <div className="relative flex-1 flex flex-col overflow-hidden">
            {/* Blurred Cart Content */}
            <div
              className="flex-1 flex flex-col overflow-hidden filter blur-md pointer-events-none select-none opacity-40 transition-all"
              aria-hidden="true"
            >
              {/* Select All Bar */}
              {cart.length > 0 && (
            ...
            {/* Próximamente blur overlay banner */}
            <div className="absolute inset-0 flex items-center justify-center p-6 bg-black/40 z-20 pointer-events-auto">
              <div className="max-w-sm w-full text-center p-6 md:p-7 bg-[#121216]/95 border border-white/15 rounded-2xl shadow-2xl space-y-4 backdrop-blur-md">
